...
def main():
    ...
    # 2. 데이터 확인
    path = "silksong_final_train_labeled.csv"
    ...
    # 3. 텍스트 데이터의 토큰화
    tokenizer = MobileBertTokenizer.from_pretrained('mobilebert-uncased', num_labels = 4)
    ...
    # 9. 모델 저장
    print("\n=== 모델 저장 ===")
    model.save_pretrained('mobilebert_silksong.pt')
    print("모델 저장 완료")
